...
The catalog has 63 independent strata:

| Category | Boss / encounter variants | Difficulties | Goal | Cells |
|---|---:|---:|---|---:|
| Priority | Deerclops, Skeletron, Queen Bee, Wall of Flesh, Duke Fishron, night Empress, day Empress, Moon Lord | Classic, Expert, Master | `priority-near-certain` | 24 |
...
Eater of Worlds and Brain of Cthulhu are separate world-evil alternatives.
The two Empress rows are deliberately separate time-of-day variants; a win
against the night fight never contributes to the daytime one. The mechanical
trio is the normal simultaneous three-mech encounter, while Mechdusa is the
